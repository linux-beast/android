...
A Small Description of the Iron V3 (V1 is IRON Los & V2 IronOS Project, V3 and V4 BlackIron Project)
----------------------------------
...
```bash
repo init -u https://github.com/Black-Iron-Project/manifest -b u14.0
```
 or you can do a shallow clone if you dont't have much bandwidth
```bash
repo init -u https://github.com/Black-Iron-Project/manifest -b u14.0 --depth=1
```
